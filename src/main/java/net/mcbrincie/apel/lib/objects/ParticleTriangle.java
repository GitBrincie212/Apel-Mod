...
public class ParticleTriangle extends ParticleObject {
    ...
    */
    ...
    public void draw(ServerWorld world, int step, Vector3f drawPos) {
        ...
        Vector3f vertex1 = new Vector3f(this.vertex1).rotateZ(this.rotation.z).rotateY(this.rotation.y).rotateX(this.rotation.x).add(totalOffset);
        Vector3f vertex2 = new Vector3f(this.vertex2).rotateZ(this.rotation.z).rotateY(this.rotation.y).rotateX(this.rotation.x).add(totalOffset);
        Vector3f vertex3 = new Vector3f(this.vertex3).rotateZ(this.rotation.z).rotateY(this.rotation.y).rotateX(this.rotation.x).add(totalOffset);
        commonUtils.drawLine(this, world, vertex1, vertex2, this.amount);
        commonUtils.drawLine(this, world, vertex2, vertex3, this.amount);
        commonUtils.drawLine(this, world, vertex3, vertex1, this.amount);
