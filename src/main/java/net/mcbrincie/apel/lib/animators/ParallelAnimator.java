...
public class ParallelAnimator extends PathAnimatorBase implements TreePathAnimator<PathAnimatorBase> {
    ...
    protected OldInterceptors<ParallelAnimator, OnRenderPathAnimator> onAnimatorRendering = OldInterceptors.identity();
    ...
    */
     ...
     */
    public void setOnAnimatorRendering(OldInterceptors<ParallelAnimator, OnRenderPathAnimator> duringRenderingSteps) {
